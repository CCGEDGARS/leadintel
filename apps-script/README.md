...
The endpoint deliberately excludes API keys, webhook URLs, private contacts,
and rejected findings. Reading the dashboard does not consume Make, Firecrawl,
OpenAI, or Apollo credits.
