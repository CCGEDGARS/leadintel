...
const DEFAULT_PLAYBOOKS=[
  ...
  {id:"crm-ai-integration",name:"Mandatory EN · Roberts introduction",offerId:"ai-sales-integration",signalId:"crm-ai",role:"Commercial or digital leader",channel:"Email",language:"English",sendMode:"Approval required",ctaMode:"Include in initial email",minScore:8,dailyLimit:3,requireHighConfidence:true,autoApproved:false,subject:MANDATORY_EN_SUBJECT,body:MANDATORY_EN_BODY,active:true}
];
...
function loadState(){
  try{
    ...
    return {
      ...
      playbooks:normalizeArray(saved.playbooks,DEFAULT_PLAYBOOKS).map(item=>{const english=item.id==="crm-ai-integration";return {...item,language:english?"English":"Latvian",sendMode:"Approval required",autoApproved:false,subject:english?MANDATORY_EN_SUBJECT:MANDATORY_LV_SUBJECT,body:english?MANDATORY_EN_BODY:MANDATORY_LV_BODY};}),
