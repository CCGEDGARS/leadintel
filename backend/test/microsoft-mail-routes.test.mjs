...
class D1Db{
  constructor(){this.raw=new DatabaseSync(':memory:');this.raw.exec(`
    ...
    CREATE TABLE gmail_messages(id TEXT PRIMARY KEY,workspace_id TEXT,idempotency_key TEXT,domain TEXT,recipient TEXT,subject TEXT,status TEXT,sent_at TEXT,customer_project_id TEXT,gmail_message_id TEXT,gmail_thread_id TEXT,created_at TEXT DEFAULT CURRENT_TIMESTAMP);
