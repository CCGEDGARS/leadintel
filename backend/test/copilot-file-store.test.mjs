...
class FakeD1 {
  ...
  run(sql,args){
    ...
    else if(/INSERT INTO copilot_file_analyses/.test(sql)){const [id,file_id,workspace_id,created_by,request,canonical_result_json,provider,model,usage_json,status,retained,source_coverage_json]=args;this.analyses.push({id,file_id,workspace_id,created_by,request,canonical_result_json,provider,model,usage_json,status,retained,source_coverage_json,created_at:new Date().toISOString()});}
