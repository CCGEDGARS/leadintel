  ...
  const stages=[
    {
      ...
      headline:"Set your starting point.",
      summary:"Tell LeadIntel what your company offers and choose the markets where you want to find opportunities.",
    ...
    },
    {
      ...
      headline:"Describe where demand comes from.",
    ...
    },
    {
      ...
      headline:"Build a useful company profile.",
      summary:"LeadIntel brings company evidence and your commercial input together in a profile you can review and approve.",
    ...
    },
    {
      ...
      headline:"Decide who to pursue.",
      summary:"Shape which customers to target, what signals to watch, and where opportunities may exist.",
    ...
    },
    {
      ...
      headline:"Find relevant companies and people.",
      summary:"LeadIntel searches your selected markets, checks evidence against your approved strategy, and surfaces likely decision-makers.",
    ...
    },
    {
      ...
      summary:"Use company and contact evidence to qualify relevant people and shape an outreach message for your review.",
    ...
    },
    {
      ...
      headline:"Deliver, track, and learn.",
      summary:"Send approved outreach, track replies and meetings, record outcomes, and use what you learn to improve the next cycle.",
