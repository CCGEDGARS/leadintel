...
export async function loadCopilot(){
  ...
  loading=(async()=>{try{
    const [api,context,ui,fileIntelligence]=await Promise.all([import('./copilot-api.js?v=20260908-copilot-polish-v1'),import('./copilot-context.js?v=20260908-copilot-polish-v1'),import('./copilot-ui.js?v=20260908-copilot-polish-v1'),import('./copilot-file-intelligence.js?v=20260909-customer-file-intelligence-v1')]);setStatus('');await ui.openCopilot?.({api,context});fileIntelligence.installCopilotFileIntelligence?.();return {api,context,ui,fileIntelligence};
