...
export async function loadCopilot(){
  ...
  loading=(async()=>{try{
    const [api,context,ui]=await Promise.all([import('./copilot-api.js?v=20260908-copilot-polish-v1'),import('./copilot-context.js?v=20260908-copilot-polish-v1'),import('./copilot-ui.js?v=20260908-copilot-polish-v1')]);setStatus('');await ui.openCopilot?.({api,context});return {api,context,ui};
