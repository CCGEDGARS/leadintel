...
export function analyzeCopilotFile(payload,options={}){return requestCopilot('/api/copilot/file-analyses',{method:'POST',body:payload,timeoutMs:CHAT_TIMEOUT_MS,signal:options.signal});}
export function continueCopilotFileAnalysis(id,message,options={}){return requestCopilot(`/api/copilot/file-analyses/${encodeURIComponent(id)}/messages`,{method:'POST',body:{message},timeoutMs:CHAT_TIMEOUT_MS,signal:options.signal});}
