...
test('Customer V2 loads the automatic company research module with Firecrawl workspace routing before research',()=>{
  ...
  assert.match(processMap,/company-research-security\.js\?v=20260916-translation-speed-v1/);
  assert.match(processMap,/company-research-ui\.js\?v=20260916-translation-speed-v1/);
  ...
  assert.match(ui,/company-research-engine\.js\?v=20260916-translation-speed-v1/);
  assert.match(read('index.html'),/profile-engine\.js\?v=20260916-commercial-brief-v1/);
  assert.match(read('index.html'),/process-map\.js\?v=20260916-translation-speed-v1/);
  assert.match(read('index.html'),/company-research-ui\.js\?v=20260916-translation-speed-v1/);
});
