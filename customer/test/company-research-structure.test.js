...
test('Customer V2 loads the automatic company research module with Firecrawl workspace routing before research',()=>{
  ...
  assert.match(processMap,/company-research-security\.js\?v=20260918-latvian-v1/);
  assert.match(processMap,/company-research-ui\.js\?v=20260918-latvian-v1/);
  ...
  assert.match(ui,/company-research-engine\.js\?v=20260918-latvian-v1/);
  ...
  assert.match(supportLoader,/company-research-ui\.js\?v=20260918-latvian-v1/);
});
