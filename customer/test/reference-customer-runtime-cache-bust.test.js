...
test('Reference Customer action modules use a fresh cache key end to end',()=>{
  ...
  assert.match(index,/process-map\.js\?v=20260924-friendly-workflow-labels-v1/);
  ...
  assert.match(processMap,/reference-customer-ai-runtime\.js\?v=20260924-reference-consensus-v1/);
  ...
  assert.match(analysis,/reference-customer-library-ui\.js\?v=20260924-reference-consensus-v1/);
  ...
  assert.match(index,/shell-support-loader\.js\?v=20260924-friendly-workflow-labels-v1/);
});
