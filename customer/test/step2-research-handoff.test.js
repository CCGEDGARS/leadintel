...
test('the repaired research handoff is cache-busted at every browser entry point',()=>{
  for(const source of [shell,processMap])assert.match(source,/company-research-ui\.js\?v=20260916-translation-speed-v1/);
  assert.match(researchUi,/company-research-engine\.js\?v=20260916-translation-speed-v1/);
