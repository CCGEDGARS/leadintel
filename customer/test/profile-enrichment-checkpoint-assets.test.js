...
test('customer workspace loads the enrichment model before its UI controller',()=>{
  const model='profile-enrichment-checkpoint.js?v=20260921-profile-enrichment-v1';
  const ui='profile-enrichment-checkpoint-ui.js?v=20260921-profile-enrichment-v1';
