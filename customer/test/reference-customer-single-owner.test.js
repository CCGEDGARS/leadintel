...
test('single-owner Reference Customer runtime is cache-busted at every changed module boundary',()=>{
  ...
  assert.match(launcher,/REFERENCE_CUSTOMER_LAUNCH_VERSION='20260924-reference-consensus-v1&opportunity-context=1&target-segments=1&profile-ux=1&target-list-edit=1'/);
});
