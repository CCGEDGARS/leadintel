...
test('outreach UI snapshots Step 1 identity, preserves edit detection and invalidates approval on regeneration',()=>{
  ...
  assert.match(discovery,/const OUTREACH_ASSET_VERSION="20260924-workspace-content-english-v1";/);
  ...
  assert.match(html,/discovery-ui\.js\?v=20260924-workspace-content-english-v1/);
});
