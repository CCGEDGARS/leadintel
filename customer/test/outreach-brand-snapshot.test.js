...
test('outreach UI snapshots Step 1 identity, preserves edit detection and invalidates approval on regeneration',()=>{
  ...
  assert.match(discovery,/const OUTREACH_ASSET_VERSION="20260925-buyers-stage-view-v1";/);
  ...
  assert.match(html,/discovery-ui\.js\?v=20260925-discovery-progress-visibility-v1/);
});
