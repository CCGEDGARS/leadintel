...
test('outreach UI snapshots Step 1 identity, preserves edit detection and invalidates approval on regeneration',()=>{
  ...
  assert.match(discovery,/const OUTREACH_ASSET_VERSION="20260922-step5-progressive-disclosure-v1";/);
  ...
  assert.match(source,/const LANGUAGE_ASSET_VERSION="20260922-step5-progressive-disclosure-v1";/);
  ...
  assert.match(html,/discovery-ui\.js\?v=20260922-step5-progressive-disclosure-v1/);
});
