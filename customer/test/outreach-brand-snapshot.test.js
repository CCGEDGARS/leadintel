...
test('outreach UI snapshots Step 1 identity, preserves edit detection and invalidates approval on regeneration',()=>{
  ...
  assert.match(discovery,/const OUTREACH_ASSET_VERSION="20260921-unified-workflow-next-actions-v1";/);
  ...
  assert.match(source,/const LANGUAGE_ASSET_VERSION="20260921-unified-workflow-next-actions-v1";/);
  assert.match(delivery,/const ASSET_VERSION="20260921-unified-workflow-next-actions-v1";/);
  ...
  assert.match(html,/process-map\.js\?v=20260919-lookalike-green-card-v1/);
  assert.match(html,/discovery-ui\.js\?v=20260921-unified-workflow-next-actions-v1/);
});
