...
function injectDiscoveryUI(){
  ...
  const content=document.querySelector("main.content");if(content&&!$("step-5"))content.insertAdjacentHTML("beforeend",`<section class="step-view" id="step-5" data-step="5">
    ...
    <section class="panel strategy-panel pipeline-panel" hidden><div class="section-title"><span class="eyebrow">Saved opportunities</span><h3>Companies selected for follow-up</h3><p>Companies you select for follow-up appear here. Review them before continuing to decision-makers and outreach.</p></div><div class="customer-pipeline" id="customer-pipeline"></div></section>
  </section>`);
}
