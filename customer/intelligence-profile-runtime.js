const INTELLIGENCE_PROFILE_ASSET_VERSION='20260909-canonical-profile-v2';
(function installIntelligenceProfileRuntime(root){
  ...
  function replaceProfileGrid(){
    ...
    upgradeStatus(state);compactSignals(profile);compactEvidence(profile);retireLegacyLookalike();
  }
