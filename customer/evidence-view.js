if(typeof window!=="undefined"){
  void import('./company-brain.js?v=20260907-company-brain-v1')
    ...
    .then(()=>import('./reference-customer-ui.js?v=20260924-reference-consensus-v1&opportunity-context=1&target-segments=1&profile-ux=1'))
    .then(()=>import('./intelligence-profile-runtime.js?v=20260924-friendly-workflow-labels-v1&target-segments=1&profile-ux=1'))
