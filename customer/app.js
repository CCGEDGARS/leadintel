...
async function activateMarketStrategy(){
  ...
  try{
    ...
    try{await window.LeadIntelWorkspacePersistence?.saveWorkspace?.();}catch(error){console.warn("Market strategy cloud save deferred",error);}
