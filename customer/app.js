...
function updateApprovalUI(){
  ...
  $("approve-profile-bottom").textContent=approved?"Continue to Market Strategy →":"Approve Profile";$("approve-profile-bottom").disabled=false;
