...
function ensureReferenceCustomerTool(){
  ...
  card.innerHTML='<div class="brand-identity-summary"><div class="brand-identity-intro"><span class="eyebrow">Customer and prospect lists</span><h3>Choose who to learn from and who to pursue</h3><p><strong>Top Customers</strong> are companies that have bought from you. Their traits provide optional buyer context. <strong>Target Companies</strong> are businesses you want to win; LeadIntel researches their fit and public demand signals before ranking any opportunity. Add either list, or use both.</p><span class="brand-identity-status">Two separate lists</span></div><button class="brand-identity-toggle lookalike-build-btn" type="button" data-reference-customers-manage><span>Add Customers</span><span aria-hidden="true">→</span></button></div>';
