(function(root,factory){
  ...
  function updateProfileApprovalUI(document,approved){
    ...
    if(continueButton){continueButton.innerHTML='Continue to Strategy <span aria-hidden="true">→</span>';continueButton.disabled=!approved;continueButton.setAttribute("aria-disabled",approved?"false":"true");}
    ...
    if(approvalTitle)approvalTitle.textContent=approved?"Your approved profile is ready for Strategy.":"Approve this profile before building your Strategy.";
