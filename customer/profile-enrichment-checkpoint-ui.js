    ...
    modal.innerHTML=`<div class="profile-enrichment-backdrop" data-enrichment-close></div>
      <section class="profile-enrichment-dialog" role="dialog" aria-modal="true" aria-labelledby="profile-enrichment-title" aria-describedby="profile-enrichment-copy">
        ...
        <div class="profile-enrichment-options">
          ...
          <article data-enrichment-item="lookalike-audience"><span class="profile-enrichment-number">02</span><div><h3>Add past customer examples</h3><p>Use actual customers as optional clues about possible buyers. LeadIntel searches for opportunities from your offers, target market and demand signals even without them.</p><em>Optional · one customer is enough to start</em></div><button class="secondary-btn" type="button" data-build-lookalike>Add Past Customers</button></article>
        </div>
