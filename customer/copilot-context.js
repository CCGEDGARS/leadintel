...
export function currentCopilotScreenContext(){
  const step=activeStep();const context={step,label:STEP_LABELS[step]||STEP_LABELS[1]};const entity=document.querySelector('[data-copilot-entity-type][data-copilot-entity-id]');
