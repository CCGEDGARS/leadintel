const SUPPORT_MODULES=[
  ...
  './reference-customer-ai.js?v=20260911-invalid-json-recovery-v1&opportunity-map=1',
  './reference-customer-ui.js?v=20260924-reference-consensus-v1&opportunity-context=1&target-segments=1&profile-ux=1&target-list-edit=1&opportunity-map=1',
  ...
  './reference-customer-ai-runtime.js?v=20260924-reference-consensus-v1&opportunity-context=1&profile-ux=1&target-list-edit=1&opportunity-map=1',
  './reference-customer-launcher.js?v=20260923-reference-interface-v1&profile-ux=1&target-list-edit=1&opportunity-map=1',
